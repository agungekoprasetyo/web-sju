...
@section('content')
<section id="subheader" class="text-light" data-bgimage="url(assets/images/motor3.jpg) top">
    <div class="center-y relative text-center">
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <div class="spacer-single"></div>
                    <h1>Asuransi Motor</h1>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 offset-md-1 d-none d-lg-block d-xl-block text-center">
                <img class="relative img-fluid" src="assets/images/motor.jpg" alt="" />
            </div>
        </div>
    </div>
</section>
...
<section id="section-about-us-2" class="no-padding text-light" data-bgcolor="#595A9E">
    <div class="image-container col-md-6 pull-left" data-bgimage="url(assets/images/motor2.jpg) center"></div>
