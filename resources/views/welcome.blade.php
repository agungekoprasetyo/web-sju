                ...
                <div id="slider-revolution">
                    <ul>
                        <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="">
                            <!--  BACKGROUND IMAGE -->
                            <img alt="" class="rev-slidebg" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" src="assets/images/banner2.jpg">

                        </li>
                        <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="">
                            <!--  BACKGROUND IMAGE -->
                            <img alt="" class="rev-slidebg" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" src="assets/images/647.jpg">

                        </li>
                        <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="">
                            <!--  BACKGROUND IMAGE -->
                            <img alt="" class="rev-slidebg" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" src="assets/images/2813.jpg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="f-box f-border f-icon-left f-icon-circle">
                                ...
                                <div class="fb-text">
                                    <h4><a href="{{url ('asuransimobil')}}">Asuransi Mobil<span></span></a></h4>
                    ...
                    <div class="row">
                            ...
                            <div class="bloglist item">
                                <div class="post-content">
                                    <div class="post-image">
                                        <img alt="" src="assets/images/news/product.png" height="350px">
                                    </div>
                                    <div class="post-text text-center">
                                        <h4><a href="news-single.html">Pick Product<span></span></a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="bloglist item">
                                <div class="post-content">
                                    <div class="post-image">
                                        <img alt="" src="assets/images/news/financial-advisor-linecolor-illustration-call-center-staff-dollar-icon-chat-bubble-vector-line-color-design-128831505.jpg" height="350px">
                                    </div>
                                    <div class="post-text text-center">
                                        <h4><a href="news-single.html">Speak to an Adviser<span></span></a></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="bloglist item">
                                <div class="post-content">
                                    <div class="post-image">
                                        <img alt="" src="assets/images/news/claim.png" height="350px">
                                    </div>
                                    <div class="post-text text-center">
                                        <h4><a href="news-single.html">Make a Claim<span></span></a></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                    </div>
                                </div>
                            </div>
